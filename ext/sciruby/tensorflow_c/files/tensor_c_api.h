...
//
// Ruby API Changes
// 1). int64_t has been changed to long long to work with SWIG
// 2). function TF_SetAttrTypeList has been changed to
//       const TF_DataType* values  ==> TF_DataType* values
// 3). function extern void TF_Run(TF_DeprecatedSession* has been changed to
